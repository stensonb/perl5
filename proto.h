...
PERL_CALLCONV UV	Perl_grok_bin_oct(pTHX_ const char* start, STRLEN* len_p, I32* flags, NV *result, const unsigned shift);
#define PERL_ARGS_ASSERT_GROK_BIN_OCT	\
	assert(start); assert(len_p); assert(flags)
...
PERL_CALLCONV bool	Perl_grok_bslash_o(pTHX_ char** s, const char* const send, UV* uv, const char** message, const bool strict, const bool silence_non_portable, U32 * packed_warn, const bool utf8)
			__attribute__warn_unused_result__;
#define PERL_ARGS_ASSERT_GROK_BSLASH_O	\
	assert(s); assert(send); assert(uv); assert(message)

PERL_CALLCONV bool	Perl_grok_bslash_x(pTHX_ char** s, const char* const send, UV* uv, const char** message, const bool strict, const bool silence_non_portable, U32 * packed_warn, const bool utf8)
			__attribute__warn_unused_result__;
